...
#define FILEDATA_SECTOR_COUNT	1	//128
...
const uint8_t BootSector[] = {
	...
	'M', 'O', 'K', 'K', 'I', '_', 'D', 'E', 'V', ' ', ' ',	// volume label
...
uint8_t DirSector[] = {
	...
	WBVAL('m'), WBVAL('o'), WBVAL('k'), WBVAL('k'), WBVAL('i'),		// five name characters in UTF-16
	0x0F,									// attributes
	0x00,									// type
	0x00,									// checksum of DOS filename (computed in ramdisk_init)
	WBVAL('i'), WBVAL('.'), WBVAL('h'), WBVAL('t'), WBVAL('m'), WBVAL('l'),	// six name characters in UTF-16
